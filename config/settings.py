"""Django settings for the personal budget tracker."""
...
# SQLite by default, so the project starts with a single command.
# Setting DB_NAME switches it over to PostgreSQL.
...
# Single currency by design: multi-currency support is deliberately out of scope.
